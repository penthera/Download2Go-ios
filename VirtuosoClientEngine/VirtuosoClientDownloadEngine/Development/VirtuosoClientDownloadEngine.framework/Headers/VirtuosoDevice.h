 ...
 */
typedef void(^DeviceUpdateResultBlock)(Boolean success, NSError* error);
 ...
 */
- (void) updateNickname:(NSString*)newNickname onComplete:(DeviceUpdateResultBlock)onComplete;
 ...
 *  @param onComplete A callback block indicating the result of the update
 */
- (void) updateDownloadEnabled:(Boolean)enabled onComplete:(DeviceUpdateResultBlock)onComplete;
 ...
 */
- (void) unregisterOnComplete:(DeviceUpdateResultBlock)onComplete;
