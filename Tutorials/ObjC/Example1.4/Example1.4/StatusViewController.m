...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (indexPath.row) {
        case taskRefillLimit:
            ...
            cell.detailTextLabel.text = [NSString stringWithFormat:@"%@", [VirtuosoSettings.instance objectForKey:@"VFM_TaskRefillLimit"] ];
            break;

        case taskRefillSize:
            cell.textLabel.text = @"Task Refill Size";
            cell.detailTextLabel.text = [NSString stringWithFormat:@"%@", [VirtuosoSettings.instance objectForKey:@"VFM_TaskRefillSize"] ];
            break;

        case timeout:
            cell.textLabel.text = @"Timeout";
            cell.detailTextLabel.text = [NSString stringWithFormat:@"%@", @(VirtuosoSettings.instance.networkTimeout)];
            break;
            
        case maxPackagerSegments:
            cell.textLabel.text = @"Max Packager Segments";
            cell.detailTextLabel.text = [NSString stringWithFormat:@"%@", [VirtuosoSettings.instance objectForKey:@"VFM_MaxPackagerSegments"]];
            break;
            
        case backgroundSetupTime:
            cell.textLabel.text = @"Packager Setup Time";
            cell.detailTextLabel.text = [NSString stringWithFormat:@"%@", @(MAX(20,[VirtuosoSettings.instance integerForKey:@"VFM_BackgroundSetupTime"]))];
            break;
            
        case maxStorage:
            cell.textLabel.text = @"Max Storage (MB)";
            cell.detailTextLabel.text = [NSString stringWithFormat:@"%@", [VirtuosoSettings.instance maxStorageAllowed] == NSIntegerMax ? @"Unlimited" : @([VirtuosoSettings.instance maxStorageAllowed]) ];
            break;

        case headroom:
            cell.textLabel.text = @"Headroom (MB)";
            cell.detailTextLabel.text = [NSString stringWithFormat:@"%@", @(VirtuosoSettings.instance.headroom)];
            break;
            
        case enableIFrames:
            cell.textLabel.text = @"Enable IFRAMES";
            cell.detailTextLabel.text = [NSString stringWithFormat:@"%@", VirtuosoSettings.instance.iframeSupportEnabled ? @"Yes" : @"No"];
            break;
            
        case cellDownload:
            cell.textLabel.text = @"Enable Cellular Download";
            cell.detailTextLabel.text = [NSString stringWithFormat:@"%@", VirtuosoSettings.instance.downloadOverCellular ? @"Yes" : @"No"];
            break;
        ...
        case maxHTTPConnections:
            ...
            cell.detailTextLabel.text = [NSString stringWithFormat:@"%@", [VirtuosoSettings.instance objectForKey:@"VFM_MaxHTTPConn"]];
            break;
...
-(void)setTaskRefillLimit:(NSIndexPath*)indexPath {
    TextValidationClosure closure = ^(NSString* input) {
        ...
        [VirtuosoSettings.instance synchronize];
    ...
    [self changeTextValueDialog:indexPath
                   ...
                   settingValue:[NSString stringWithFormat:@"%@", [VirtuosoSettings.instance objectForKey:@"VFM_TaskRefillLimit"]]
...
-(void)setTaskRefillSize:(NSIndexPath*)indexPath {
    ...
    [self changeTextValueDialog:indexPath
                   ...
                   settingValue:[NSString stringWithFormat:@"%@", [VirtuosoSettings.instance objectForKey:@"VFM_TaskRefillSize"]]
                   keyboardType:UIKeyboardTypeNumberPad];
}
...
-(void)setTimeout:(NSIndexPath*)indexPath {
    ...
    [self changeTextValueDialog:indexPath
                   ...
                   settingValue:[NSString stringWithFormat:@"%@", @(VirtuosoSettings.instance.networkTimeout)]
                   keyboardType:UIKeyboardTypeNumberPad];
}
...
-(void)setMaxHTTPConnections:(NSIndexPath*)indexPath {
    ...
    [self changeTextValueDialog:indexPath
                   ...
                   settingValue:[NSString stringWithFormat:@"%@", [VirtuosoSettings.instance objectForKey:@"VFM_MaxHTTPConn"]]
                   keyboardType:UIKeyboardTypeNumberPad];
}
...
-(void)setMaxPackagerSegments:(NSIndexPath*)indexPath {
    ...
    [self changeTextValueDialog:indexPath
                   ...
                   settingValue:[NSString stringWithFormat:@"%@", [VirtuosoSettings.instance objectForKey:@"VFM_MaxPackagerSegments"]]
                   keyboardType:UIKeyboardTypeNumberPad];
}
...
-(void)setMaxHeadroom:(NSIndexPath*)indexPath {
    TextValidationClosure closure = ^(NSString* input) {
        ...
        [VirtuosoSettings.instance overrideHeadroom:iVal];
    };
    ...
    [self changeTextValueDialog:indexPath
                   ...
                   settingValue:[NSString stringWithFormat:@"%@", @(VirtuosoSettings.instance.headroom)]
                   keyboardType:UIKeyboardTypeNumberPad];
}
...
-(void)setMaxStorage:(NSIndexPath*)indexPath {
    TextValidationClosure closure = ^(NSString* input) {
        ...
        [VirtuosoSettings.instance overrideMaxStorageAllowed:iVal];
    };
    
    NSString* currentValue;
    if ([VirtuosoSettings.instance maxStorageAllowed] == NSIntegerMax) {
        currentValue = @"";
    } else {
        currentValue = [NSString stringWithFormat:@"%@", @([VirtuosoSettings.instance maxStorageAllowed])];
    }
    [self changeTextValueDialog:indexPath
                        closure:closure
...
-(void)setBackgroundSetupTime:(NSIndexPath*)indexPath {
    ...
    [self changeTextValueDialog:indexPath
                   ...
                   settingValue:[VirtuosoSettings.instance objectForKey:@"VFM_BackgroundSetupTime"]
                   keyboardType:UIKeyboardTypeNumberPad];
}
...
-(void)setEnableIFrames:(NSIndexPath*)indexPath {
    BooleanValidationClosure closure = ^(Boolean input) {
        VirtuosoSettings.instance.iframeSupportEnabled = input;
    };
    ...
    [self changeBooleanValueDialog:indexPath
                   ...
                   settingValue:[NSString stringWithFormat:@"%@", @(VirtuosoSettings.instance.iframeSupportEnabled)]];
}
...
-(void)setCellularDownload:(NSIndexPath*)indexPath {
    BooleanValidationClosure closure = ^(Boolean input) {
        [VirtuosoSettings.instance overrideDownloadOverCellular:input];
    };
    ...
    [self changeBooleanValueDialog:indexPath
                      ...
                      settingTitle:@"Enable Cellular Download"
                       settingName:@"Default No"
                      settingValue:[NSString stringWithFormat:@"%@", @(VirtuosoSettings.instance.downloadOverCellular)]];
}
