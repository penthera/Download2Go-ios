Tutorial - Example1.6: Wait for completion of asset refreshManifestAndDownload
=======================================
## Summary
This sample demonstrates how asset refreshManifestAndDownload works for adding new audio languages to a previous download. 
