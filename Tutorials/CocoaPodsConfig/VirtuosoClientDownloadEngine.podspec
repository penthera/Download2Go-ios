...
# Specifications for the local installation of the VituosoClientDownloadEngine
...
Pod::Spec.new do |s|
  ...
  s.source           = { :http => 'file:' + __dir__ + '/../../VirtuosoClientEngine/CocoaPodsProducts/VirtuosoClientDownloadEngine.zip' } 
