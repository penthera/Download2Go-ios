...
RCT_EXPORT_MODULE(Example1_1Controller);
...
RCT_EXPORT_METHOD(pauseDownload: (BOOL) pause)
{
  NSLog(@"pauseDownload bridge method invoked");
  ...
  self.exampleAsset.isPaused = pause;
  
  [self refreshView:DownloadingAsset asset:self.exampleAsset];
}
