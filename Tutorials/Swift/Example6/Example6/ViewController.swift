...
class ViewController: UIViewController, VirtuosoDownloadEngineNotificationsDelegate, VirtuosoAdsManagerNotificationDelegate {
    ...
    @IBAction func downloadBtnClicked(_ sender: UIButton)
    {
        ...
        DispatchQueue.global(qos: .background).async {
            ...
            config.adsProvider = VirtuosoGoogleAdsClientProvider(refreshUrl: self.adsUrl)
    ...
    func adsTrackingNotification(for asset: VirtuosoAsset?, url: String, userInfo: [AnyHashable : Any] = [:]) {
        self.statusLabel.text = "Ad tracking url:\(url)"
    }
