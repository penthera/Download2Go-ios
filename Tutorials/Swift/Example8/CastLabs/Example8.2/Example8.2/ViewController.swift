...
class ViewController: UIViewController, VirtuosoDownloadEngineNotificationsDelegate {
    ...
    private var sampleAssetManifestUrl: String? = nil               // <-- replace this with a proper value
    private var sampleAssetType = kVDE_AssetType.vde_AssetTypeHLS   // This must match the asset type for sampleAssetManifestUrl

    private var certificateUrl: String? = nil       // <-- replace this with a proper value
    private var licenseUrl: String? = nil           // <-- replace this with a proper value
    private var authenticationXml: String? = nil    // <-- replace this with a proper value
    private var userID: String? = nil               // <-- replace this with a proper value
    private var customerName: String? = nil         // <-- replace this with a proper value
    private var sessionID: String? = nil            // <-- replace this with a proper value
